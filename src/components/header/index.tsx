...
export const Header = () => (
  <nav className="fixed inset-0 z-50 h-16 items-center justify-between border-b border-border/50 bg-muted/10 backdrop-blur-md">
    <div className="relative m-auto flex h-16 w-full max-w-5xl items-center justify-between px-8">
      <h1 className="center gap-1 text-xl font-black">
        <svg className="w-8" viewBox="0 0 256 256">
