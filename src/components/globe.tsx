...
export const Globe: FC<Props> = ({
  ...
  return (
    <div className={className}>
      <div
        className={"w-full aspect-square m-auto relative"}
        style={{
          maxWidth: size,
          maxHeight: size
        }}
      >
        <canvas
          ref={canvasRef}
          className="w-full h-full cursor-grab opacity-0 [transition:opacity_1000ms_ease]"
          onPointerDown={(e) => {
